...
@interface HXWaterfallFlowlayout ()
...
@property (nonatomic,weak) id<HXWaterfallFlowlayoutDelegate> delegate;

@end

@implementation HXWaterfallFlowlayout
...
#pragma mark - 获取collectionView参数
- (id<HXWaterfallFlowlayoutDelegate>)delegate
{
    if (_delegate == nil) {
        _delegate =  (id<HXWaterfallFlowlayoutDelegate>)self.collectionView.delegate;
    }
